...
// extern template class std::vector<MayFail<ProgramSentence>>;
...
// extern template class std::vector<MayFail<ProgramWord>>;
...
// extern template class std::vector<MayFail<Term>>;
// extern template class std::optional<MayFail<Term>>;
...
// extern template class std::vector<MayFail<Word>>;
